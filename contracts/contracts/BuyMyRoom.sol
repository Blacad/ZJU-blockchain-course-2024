...
contract BuyMyRoom {
    ...
    mapping(address =>mapping(uint256 => House)) public houses; // A map from house-index to its information
    constructor() {
     ...
     function list(address _nftAddr, uint256 _tokenId, uint256 _price) public{
        ...
        House storage _house = houses[_nftAddr][_tokenId]; //设置NF持有人和价格
    ...
    function purchase(address _nftAddr, uint256 _tokenId) public payable {
        House storage _house = houses[_nftAddr][_tokenId]; // 取得House
        ...
        delete houses[_nftAddr][_tokenId]; // 删除order
